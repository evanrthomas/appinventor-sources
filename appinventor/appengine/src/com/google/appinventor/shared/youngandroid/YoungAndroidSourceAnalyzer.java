...
public class YoungAndroidSourceAnalyzer {
   ...
   */
  public static final String FORM_PAGE_SOURCE_EXTENSION = ".bky";
  public static final String SHARED_PAGE_SOURCE_EXTENSION = ".sbky";
  ...
  public static boolean isBlocksNodeSourceFileId(String fileId) {
    return fileId.endsWith(FORM_PAGE_SOURCE_EXTENSION) || fileId.endsWith(SHARED_PAGE_SOURCE_EXTENSION);
  }

  public static String getExtension(String fileId) {
    return fileId.substring(fileId.lastIndexOf(".")).toLowerCase();
  }
}
