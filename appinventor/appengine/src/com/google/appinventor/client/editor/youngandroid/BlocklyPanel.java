...
public class BlocklyPanel extends HTMLPanel {
  ...
  // My blocks editor
  private YaCodePageEditor myBlocksEditor;  // [lyn, 2014/10/28] Added to access current form json

  public static boolean isWarningVisible = false;

  public BlocklyPanel(YaCodePageEditor blocksEditor, String formName) {
