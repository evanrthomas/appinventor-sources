...
public class ProjectToolbar extends Toolbar {
  ...
  private static class DeleteAction implements Command {
    @Override
    public void execute() {
      Helper.println("ProjectToolbar$DeleteAction.execute()");
      ...
      if (selectedProjects.size() > 0) {
        ...
        Helper.println("ProjectToolbar$DeleteAction.execute() complete");
      } else {
    ...
    private void deleteProject(Project project) {
      ...
      Helper.println("ProjectToolbar$DeleteAction.deleteProject()");
      ...
      if (isCurrentProject) { //only executes if is currently open

        Helper.println("ViewerBox.getViewrBox().clear()");
        ...
        Helper.println("ViewerBox.getViewrBox().clear() complete");

        Helper.println("ProjectToolbar$DeleteAction.closeProjectEditor()");
        ode.getEditorManager().closeProjectEditor(projectId);
        Helper.println("ProjectToolbar$DeleteAction.closeProjectEditor() complete");
      }
      ...
      Helper.println("ProjectToolbar$DeleteAction.deleteProject() complete");
    }
